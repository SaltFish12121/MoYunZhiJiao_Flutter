...
class AppColors {
  ...
  // 常用颜色常量
  static const Color black333 = Color(0xFF333333); // 深灰色
}

class AppStyle {
  // 亮色主题配置
  static ThemeData lightTheme = ThemeData(
    colorScheme: AppColors.lightColorScheme, // 使用亮色方案
    useMaterial3: true, // 启用Material 3设计
    // Windows平台使用微软雅黑字体
    fontFamily: Platform.isWindows ? "Microsoft YaHei" : null,
    visualDensity: VisualDensity.standard, // 标准视觉密度
    appBarTheme: AppBarTheme(
      centerTitle: true, // 标题居中
      titleTextStyle: const TextStyle(
        fontSize: 16,
        color: AppColors.black333, // 标题文字颜色
      ),
      foregroundColor: AppColors.black333, // 前景色
      // 系统覆盖层样式（状态栏/导航栏）
  ...
  static ThemeData darkTheme = ThemeData.dark().copyWith(
    colorScheme: AppColors.darkColorScheme, // 使用暗色方案
    visualDensity: VisualDensity.standard,
    // 文本主题（Windows平台使用微软雅黑）
  ...
  // 垂直间距常量
  static const vGap4 = SizedBox(height: 4); // 4像素垂直间距
  ...
  // 水平间距常量
  static const hGap4 = SizedBox(width: 4); // 4像素水平间距
  ...
  // 圆角半径常量
  static BorderRadius radius4 = BorderRadius.circular(4); // 4像素圆角
  ...
  static Divider get divider => Divider(
        ...
        indent: 16, // 起始缩进
        endIndent: 16, // 结束缩进
        color: Colors.grey.withAlpha(25), // 半透明灰色
      );
}
